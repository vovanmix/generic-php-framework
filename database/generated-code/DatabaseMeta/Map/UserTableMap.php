...
class UserTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'DatabaseMeta.Map.UserTableMap';
     ...
     */
    const OM_CLASS = '\\DatabaseMeta\\User';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'DatabaseMeta.User';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID, UserTableMap::COL_NAME, UserTableMap::COL_PASSWORD, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(UserTableMap::COL_ID => 0, UserTableMap::COL_NAME => 1, UserTableMap::COL_PASSWORD => 2, ),
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\DatabaseMeta\\User');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \DatabaseMeta\User) { // it's a model object
